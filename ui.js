...
var ui = {
	...
	virtualdisplay: {
		...
		display: document.getElementById('virtualdisplay'),
		multiplyer: document.getElementById('virtualdisplaysize')
	},
	robotDiagram: {
...
function onValueChanged(key, value, isNew) {
	...
	switch (key) {
		...
		case '/SmartDashboard/Camera/target0/x_axis':
			...
			var x_axis = value;
			ui.virtualdisplay.target0.x = value;
			break;
		//Y Axis
		case '/SmartDashboard/Camera/target0/y_axis':
			// Calculate Visual Graphics
			var y_axis = value;
			ui.virtualdisplay.target0.y = value;
			break;
		//Height
		case '/SmartDashboard/Camera/target0/height':
			// Calculate Visual Graphics
			var height = value;
			ui.virtualdisplay.target0.height = value;
			break;	
		//Width
		case '/SmartDashboard/Camera/target0/width':
			// Calculate Visual Graphics
			var width = value;
			ui.virtualdisplay.target0.width = value;
			break;	
